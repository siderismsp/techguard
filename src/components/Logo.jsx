export default function Logo({ size = 28 }) {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 120" width={size * 3.5} height={size * 0.85} style={{ display: 'block' }}>
      ...
      <text x="130" y="58" fontSize="34" fontWeight="800" fill="#FFFFFF" letterSpacing="1.5">
        TECH<tspan fill="#00A3FF">GUARD</tspan>
      </text>

      <text x="132" y="82" fontSize="12" fontWeight="600" fill="#8B949E" letterSpacing="4">
      ...
      <g transform="translate(132, 92)">
        ...
        <text x="20" y="12" fontSize="9" fontWeight="700" fill="#C9D1D9" letterSpacing="0.5">TECHNITIUM INTEGRATED</text>
      </g>
    </svg>
  )
}